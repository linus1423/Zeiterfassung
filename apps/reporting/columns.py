...
COLUMNS: tuple[Column, ...] = (
    ...
    Column("period_label", "Abrechnungszeitraum", TEXT),
    Column("period_start", "Zeitraum von", DATE),
    Column("period_end", "Zeitraum bis", DATE),
    Column("period_closed", "Abgeschlossen", TEXT),
