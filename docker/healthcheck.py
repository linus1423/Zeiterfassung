...
Absichtlich ohne zusaetzliches Paket im Image (kein curl) und absichtlich gegen
/healthz statt /readyz: eine kurze Stoerung der Datenbank soll den Webdienst
...
# Die Anfrage geht an den eigenen Prozess und darf deshalb nie ueber einen
